...
#include "../objects/PolylineObject.hpp"
#include "../objects/PolygonObject.hpp"
#include <GL/glut.h>

inline PolylineObject* currentPolyline = nullptr;
inline PolygonObject* currentPolygon = nullptr;
inline bool waitingSecondPoint = false;
// inline Object* selected = scene.getSelected();
inline Vec2 firstPoint;
...
inline void keyboardCallback(unsigned char key, int, int) {
